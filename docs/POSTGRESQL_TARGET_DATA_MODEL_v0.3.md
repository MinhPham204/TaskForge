...
> **Phạm vi:** Target relational model; không phải TypeORM entity, migration SQL, implementation plan hoặc Refactor Roadmap.
...
- Milestone `status_code`: `OPEN`, `CLOSED`.
- Risk `likelihood_code` and `impact_code`: `LOW`, `MEDIUM`, `HIGH`.
